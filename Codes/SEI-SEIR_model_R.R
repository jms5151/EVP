# Rainfall dependent SEI-SEIR model
# need to give a mean temperature & should determine whether to use a generic constant temperature or site-specific mean temperature
seiseir_model_r <- function(t, state, parameters) {
