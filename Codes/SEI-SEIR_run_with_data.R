...
# Run SEI-SEIR model with temperature, humidity and rainfall data and transovarial transmission -----------------
# it helps to have R return to S
# transovarial transmission is helpful too
# reducing susceptible within SEI-SEIR model is also helpful
