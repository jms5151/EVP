...
# climateDataEcuador0215 <- read.csv("Concatenated_Data/climate_data/gapfilled_climate_data_Ecuador_2002-2015.csv", head=T)
# climateDataEcuador1617 <- read.csv("Concatenated_Data/climate_data/gapfilled_climate_data_Ecuador_2016-2017.csv", head=T)
climateDataEcuador <- read.csv("Concatenated_Data/climate_data/gapfilled_climate_data_Ecuador_2002-2017.csv", head=T)
...
# climateDataEcuador <- rbind(climateDataEcuador0215, climateDataEcuador1617)
