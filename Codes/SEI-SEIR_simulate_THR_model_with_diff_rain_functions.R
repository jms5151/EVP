# Test different rainfall function using the THR SEI-SEIR model ------------------------------
...
traitFileName <- "Concatenated_Data/model_simulations/SEI-SEIR_simulations_THR_test_diff_rain_functions.csv"
...
for (i in 1:length(sites)){
  climateData2 <- subset(climateData, Site == sites[i] & Date >= "2013-06-14")
